...
% ---------------------------------------------------------------------------
\input{sections/01_prologue.tex}      % title-question, Real -> Current

% ---------------------------------------------------------------------------
% the "what is AI?" meme, just before the Agenda begins
% ---------------------------------------------------------------------------
\begin{frame}{Wait... what is AI, again?}{just statistics with confidence}
    \begin{center}
        \includegraphics[height=6.5cm]{assets/img/meme_whatisai.jpg}
    \end{center}
\end{frame}

\input{sections/02_agenda.tex}        % venn diagram, the goal
\input{sections/03_tooltime.tex}      % what kind of tools, are they AI?
\input{sections/04_ailandscape.tex}   % umbrella, next-token, lens, axis, alignment
\input{sections/05_fundamentals.tex}  % services, about me, storage, all text
\input{sections/06_knowledge.tex}     % compression, distribution, too much math
\input{sections/07_tools.tex}         % git, latex, do it yourself?
\input{sections/08_agents.tex}        % agentic tools
...
\begin{frame}[plain]
    ...
    \begin{center}
        ...
        \vspace{0.5cm}
        \includegraphics[height=2.9cm]{assets/img/qr_githubio.png}
        \vspace{0.3cm}
